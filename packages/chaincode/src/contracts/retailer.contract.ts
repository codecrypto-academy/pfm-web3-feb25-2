...
@Info({ title: 'RetailerContract', description: 'Allows Retailer to Manage Phone Assets' })
export class RetailerContract extends Contract {
    ...
    public async transferPhoneAsset(
        ...
        const signerKey = this.getKey('user:retailer', signerAddress);
        ...
        const newOwnerKey = this.getKey('user:consumer',newOwner)
